    ...
    <div className="relative w-full">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-9/12">
        ...
        <div className="">
          ...
          <div className="absolute top-0 left-1/3 translate-x-20 translate-y-60 w-44">
            <img src="/images/banner/ellipse.png" alt="" />
            <p className="text-3xl font-medium mt-14 ml-3">Kết nối cộng đồng</p>
          </div>
          <Link to={"/"}>
            <div className="absolute top-1/2 right-1/3 translate-y-24 translate-x-32 w-40">
              <img src="/images/banner/ellipse.png" alt="" />

              <p className="text-3xl font-medium mt-12">Tư vấn</p>
            </div>
          </Link>
          <div className="absolute top-0 right-0 translate-y-16 -translate-x-36 w-40">
            ...
            <p className="text-3xl font-medium mt-4 ml-8">Thư viện luật</p>
          </div>
        </div>
      </div>
