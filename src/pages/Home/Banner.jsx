  ...
  return (
    <div className="relative w-full">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-9/12">
        ...
        <div className="">
          <Link to="/dao-tao">
            <div className="absolute top-0 left-0 translate-y-14 translate-x-36">
              <img src="/images/banner/ellipse.png" alt="" />
              <p className="text-3xl font-medium mt-16">Đào tạo</p>
            </div>
          </Link>
          <Link to={"/"}>
            <div className="absolute top-0 left-0 translate-x-96 translate-y-32 w-56">
              ...
              <p className="text-3xl font-medium ml-6 mt-8">
                Quản lý doanh nghiệp
              </p>
            </div>
          </Link>
          <Link to={"/ket-noi"}>
            <div className="absolute top-1/2 right-0 translate-y-16 -translate-x-72 w-40">
              <img src="/images/banner/ellipse.png" alt="" />
              <p className="text-3xl font-medium mt-12">Kết nối cộng đồng</p>
            </div>
          </Link>
          <Link to="/tu-van">
            <div className="absolute top-0 right-0 translate-y-28 -translate-x-36">
              <img src="/images/banner/ellipse.png" alt="" />
              <p className="text-3xl font-medium">Tư vấn</p>
            </div>
          </Link>
